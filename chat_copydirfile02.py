...
source_file_user = input("Enter the source file path: ")
...
try:
    shutil.copy(source_file_user, destination_directory1)
    print(f"File '{source_file_user}' copied to '{destination_directory1}' successfully.")
