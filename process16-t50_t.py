...
job_id_keyword = [
                  #'SLT0410_Versal2_VE3858_SSVA2112_XT50AV_202508011656'
                  #'SLT0410_Versal2_VE3858_SSVA2112_XT50AV_202508061356'
                  #'SLT0410_Versal2_VE3858_SSVA2112_XT50AV_202508081030'
                  #'retest'
                  #'SLT0410_Versal2_VE3858_SSVA2112_XT50AV_202508151443'
                  'SLT0410_Versal2_VE3858_SSVA2112_XT50AV_202508220909_retest'
                  ]
...
try:
    start_index = test_columns.index('contact_check_lp5_LP5_MC4')
...
# Evaluate remarks based on test results
...
# Step 1: Filter only rows with FailCheck == 'TIC' ->'FailingUnit'
tic_rows = df_tab2[df_tab2['FailCheck'] == 'FailingUnit'].copy()

# --- IMPROVED: Sort by Serial_Number and Date descending to get latest run first ---
tic_rows = tic_rows.sort_values(['Serial_Number', 'Date'], ascending=[True, False])
...
# --- Keep only the latest failing run per Serial_Number ---
tic_unique = tic_rows.drop_duplicates(subset='Serial_Number', keep='first').reset_index(drop=True)
